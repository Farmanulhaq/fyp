...
const Verify = () => {
	...
	const checkData = async (event) => {
		let data = document.getElementById("login").value
				...
				<div class="l-screen">
					<div class="overlay">
						<div class="overlay-panel overlay-right">
							...
							<div class='list'>
								<li>Install metamask extension if not downloaded</li>
								<li>Enter auction sheet chasis number</li>
								<li>Click on verify</li>
								<li>Confirm transaction on metamask extension that pop up</li>
								<li>Original auction sheet pdf will open in new tab you can download it</li>
								<li>A backup of the link will be send to your email. Save it for further use</li>
							</div>
